...
| synthetic-audio-render-slice-plan | internal_spec | plan | Deterministic rights-safe synthetic audio render foundation | `docs/superpowers/plans/2026-06-13-mpc2000xl-synthetic-audio-render.md` |
| host-audio-plumbing-slice-plan | internal_spec | plan | Deterministic host-audio backend plumbing foundation | `docs/superpowers/plans/2026-06-13-mpc2000xl-host-audio-plumbing.md` |
...
| midi-device-io-foundation-slice-plan | internal_spec | plan | Optional native MIDI device input/output adapter foundation | `docs/superpowers/plans/2026-06-14-mpc2000xl-midi-device-io-foundation.md` |
...
| program-pad-mute-group-foundation-slice-plan | internal_spec | plan | PROGRAM pad mute-group metadata and host-audio choke foundation | `docs/superpowers/plans/2026-06-14-mpc2000xl-program-pad-mute-group-foundation.md` |
